...
props: []
steps:
  - { pose: "easy-pose",      seconds: 60,  sides: 1, note: "Sit tall, close the eyes, and take a few slow breaths to arrive." }
  - { pose: "butterfly",      seconds: 120, sides: 1, note: "Soles together, fold gently — a soft opening for the hips and back." }
  - { pose: "sphinx",         seconds: 120, sides: 1, note: "Prop onto the forearms and lift the chest to wake the spine." }
  - { pose: "banana",         seconds: 90,  sides: 2, note: "Curve into a crescent and breathe into the whole side body." }
