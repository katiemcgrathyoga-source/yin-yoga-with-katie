...
benefits:
  ...
  - "Releases the lower back and the outer hip, where we tend to hold tension without realizing it."
  - "Gently wrings and massages the abdominal organs, which can settle digestion."
  - "Opens the chest as the top arm reaches away, inviting a slower, fuller breath."
  - "A classic wind-down shape — deeply calming for the nervous system before rest."
cues:
...
transitions_in:
  - "From lying on your back, hug the knees into the chest, then let them drop to one side."
transitions_out:
  - "Come out slowly — draw the knees back to center using your belly, and pause on your back before the second side."
counterposes:
  - "Rest on your back with knees bent, feet on the floor, and let the spine re-center for a few breaths."
  - "A gentle knees-to-chest hug to neutralise the lower back."
cautions:
  ...
  - "In later pregnancy, favor an open twist (knees only lightly to the side) rather than a deep closed one."
